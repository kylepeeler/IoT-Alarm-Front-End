...
class NextAlarmSettingsForm extends React.Component {
    ...
    render() {
        ...
        return <div className={classes.modal}>
            ...
            <FormGroup>
                <FormControlLabel control={<Switch checked={this.state.displayAsCountdown} onChange={this.handleChangeDisplayFormat} value="displayAsCountdown" />} label="Display as countdown until next alarm?" />
